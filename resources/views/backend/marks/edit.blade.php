          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <a href="{{route('user.view')}}" class="btn btn-success orange float-right btn-sm">  <i class="nav-icon fas fa-list"></i>Category List</a>
              </div>
              <!-- /.card-header -->
            ...
            <div class="card card-danger">
             <form action="{{route('category.update',$editData->id)}}" id="quickForm" method="POST">
              @csrf
